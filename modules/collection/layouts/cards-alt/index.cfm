<cfsilent>		
	...
	<cfparam name="objectParams.bgStyle" default="text-dark bg-white">
	<cfparam name="objectParams.hoverStyle" default="">
...
<div class="mura-collection #objectParams.gridstyle# card-deck">
	...
	<div class="mura-collection-item mb-4">
		...
		<div class="mura-collection-item__holder card card-alt p-0 border-0"> <!--- #item.getValue('CardBackgroundStyle')# --->
			...
			<div class="card-body border-bottom_#esapiEncode('html_attr', objectParams.borderbottomcolor)# #objectParams.bgStyle# <cfif len(objectParams.hoverStyle)>hover_</cfif>#objectParams.hoverStyle#">
				#m.dspObject_include(
			...
			<a href="#item.getUrl()#" target="#item.getTarget()#" class="stretched-link"></a>
		</div>
	</div>
	</cfloop>
</div>
